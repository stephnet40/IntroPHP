...
if(isset($_SESSION['admin_name'])) {
	if($_SESSION['admin_name'] != $adminName) {
	...
	<body>
		...
		<main id="admin_home">
			...
			<div class="main">
				...
				<div>
					<a href="add_recipe.php"><img src="../images/admin_add_recipe_img.png"></a>
					<h3><a href="add_recipe.php">ADMIN: ADD RECIPE</a></h3>
				</div>
				
				<div>
					<a href="add_recipe.php"><img src="../images/admin_viewall_img.png"></a>
					<h3><a href="add_recipe.php">ADMIN: VIEW ALL</a></h3>
				</div>
